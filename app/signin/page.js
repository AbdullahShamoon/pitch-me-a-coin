            ...
            <div className="SignIn bg-[#ecf0f1] min-h-screen w-full flex ">
                <div className="container h-fit bg-white mx-auto rounded-lg mt-5 px-5 w-fit shadow-xl">
                    <div className="head flex flex-col items-center">
                        ...
                        <h2 className='text-gray-900 text-sm font-kanit'>Login below or create an account to continue.</h2>
                    </div>
                    <div className="line h-[1px] mt-3 w-full bg-gradient-to-r from-transparent via-black to-transparent "></div>
